  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glass': '0 1px 2px rgb(0 0 0 / 0.1), inset 0 1px 1px rgb(255 255 255 / 0.05)',
        'glass-lg': '0 4px 24px rgb(0 0 0 / 0.15), inset 0 1px 1px rgb(255 255 255 / 0.06)',
        'glow': '0 0 40px hsl(var(--accent) / 0.15)',
        'glow-lg': '0 0 60px hsl(var(--accent) / 0.25)',
        'card': '0 8px 32px hsl(0 0% 0% / 0.2)',
      },
